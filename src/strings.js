...
es: {
  ...
  'final.1.cierre'         : 'Sale con lo puesto y sin mirar atrás. Sobrevivir también es un resultado.',
  'final.2.titulo'         : 'La dueña de la veta',
  'final.2.cierre'         : 'Sale forrada de gemas. Mira atrás y hace la cuenta de lo que dejó abajo.',
...
en: {
  ...
  'final.1.cierre'         : 'Out with nothing but her helmet, not looking back. Surviving counts too.',
  'final.2.titulo'         : 'Queen of the Vein',
  'final.2.cierre'         : 'Out loaded with gems. She looks back and counts what she left down there.',
